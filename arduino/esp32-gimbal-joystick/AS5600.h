...
// Based on original Rob Tillaart'AS5600
// Modified to use Software I2C (SoftWire) instead of Wire.h
...
public:
  ...
  [[deprecated("Use setConfiguration()")]] bool setConfigure(uint16_t value) {
    return setConfiguration(value);
  };
  [[deprecated("Use getConfiguration()")]] uint16_t getConfigure() {
  ...
  [[deprecated("use magnetDetected()")]] bool detectMagnet() {
